...
locE10 = str(
    priceDataAPI["regions"][regionPref]["prices"][0]["suburb"]
    + ", "
    + priceDataAPI["regions"][regionPref]["prices"][0]["state"]
)

priceU91 = float(priceDataAPI["regions"][regionPref]["prices"][1]["price"])
locU91 = str(
    priceDataAPI["regions"][regionPref]["prices"][1]["suburb"]
    + ", "
    + priceDataAPI["regions"][regionPref]["prices"][1]["state"]
)

priceU95 = float(priceDataAPI["regions"][regionPref]["prices"][2]["price"])
locU95 = str(
    priceDataAPI["regions"][regionPref]["prices"][2]["suburb"]
    + ", "
    + priceDataAPI["regions"][regionPref]["prices"][2]["state"]
)

priceU98 = float(priceDataAPI["regions"][regionPref]["prices"][3]["price"])
locU98 = str(
    priceDataAPI["regions"][regionPref]["prices"][3]["suburb"]
    + ", "
    + priceDataAPI["regions"][regionPref]["prices"][3]["state"]
)

priceDiesel = float(priceDataAPI["regions"][regionPref]["prices"][4]["price"])
locDiesel = str(
    priceDataAPI["regions"][regionPref]["prices"][4]["suburb"]
    + ", "
    + priceDataAPI["regions"][regionPref]["prices"][4]["state"]
)

priceLPG = float(priceDataAPI["regions"][regionPref]["prices"][5]["price"])
locLPG = str(
    priceDataAPI["regions"][regionPref]["prices"][5]["suburb"]
    + ", "
    + priceDataAPI["regions"][regionPref]["prices"][5]["state"]
)

# Print the last updated time
print(
    "Prices last updated at: ", strftime("%a %d %b %Y %H:%M:%S", localtime(lastUpdated))
)
